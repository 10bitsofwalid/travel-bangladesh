...
export const LeftFilterPanel: React.FC = () => {
  ...
  if (!isLeftPanelOpen) {
    return (
      <button
        ...
        className="absolute top-[108px] sm:top-[124px] left-3 sm:left-5 z-40 glass-panel p-2 sm:p-2.5 rounded-2xl shadow-xl flex items-center gap-1.5 sm:gap-2 text-xs font-bold text-slate-800 hover:scale-105 transition-all cursor-pointer pointer-events-auto border border-white/80"
  ...
  return (
    <aside
      className="absolute top-[108px] sm:top-[124px] left-3 sm:left-5 z-40 w-[calc(100vw-24px)] max-w-[280px] sm:w-[290px] lg:w-[310px] glass-panel rounded-3xl p-4 sm:p-5 shadow-2xl space-y-3.5 sm:space-y-4 pointer-events-auto select-none transition-all duration-300 animate-in fade-in slide-in-from-left-4 max-h-[calc(100vh-260px)] overflow-y-auto border border-white/85"
